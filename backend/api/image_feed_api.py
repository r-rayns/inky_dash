...
@inject
def get_image_feed(
    image_feed_service: ImageFeedService = Provide[Container.image_feed_service],
):
    try:
        ...
        return error_response("Error retrieving existing image feed configuration", err)
...
def set_image_feed(
    ...
    try:
        ...
        return error_response("Failed to update image feed", err)
