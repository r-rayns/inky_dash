...
// TODO blank image for each size with the image dimensions in text centered.
// TODO reset all images when new display type is selected
// TODO check upload image has correct dimensions
const blankImage =
    ...
    <>
      ...
      >
        ...
        <p className="absolute top-0 left-0 px-1 font-mono text-xs m-0 backdrop-blur-sm bg-black/50 text-slate-300">
          Dimensions: {actualDimensions?.width} x{" "}
