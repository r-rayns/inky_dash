...
export default function ThemeToggle({
  ...
  return (
    <Button
      ...
      className={clsx(
        'rounded-full w-8 h-8 md:w-10 md:h-10 md:rounded-md drop-shadow-md bg-muted hover:cursor-pointer hover:drop-shadow-lg\n' +
          'p-1 text-muted-foreground hover:text-primary-foreground',
        props.className,
      )}
    >
      {theme === Theme.DARK ? (
