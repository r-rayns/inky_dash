        ...
        >
          <div className="flex gap-2 items-center w-full max-w-xs text-gray-500  dark:text-gray-400 ">
            {(() => {
              switch (toast.options.type) {
                ...
                case ToastType.INFO:
                  return (
                    <div className="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-violet-100 bg-violet-500 rounded-lg dark:bg-violet-800 dark:text-violet-200">
                ...
                case ToastType.SUCCESS:
                  return (
                    <div className="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-green-100 bg-green-600 rounded-lg dark:bg-green-800 dark:text-green-200">
                      <CheckIcon />
                ...
                case ToastType.ERROR:
                  return (
                    <div className="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-red-100 bg-red-500 rounded-lg dark:bg-red-800 dark:text-red-200">
                      <ErrorIcon />
          ...
          <div className="relative bottom-[-10px]">
            ...
            <div
              ...
              style={{ '--duration': toast.options.duration } as CSSProperties}
            ></div>
          </div>
        </div>
      ))}
