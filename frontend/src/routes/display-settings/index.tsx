...
import { BorderColour, DefaultSettings, DisplayMode, DisplayType, Palette } from '@/types/display';
...
function DisplaySettingsPage() {
  ...
  const hasSevenColourPalette = displayClass.palettes.includes(Palette.SEVEN_COLOUR);
